        ...
        <div
          ...
          ${showSmallJournal && style.smallJournal}`}>
            ...
            <div className={`flex ${style.detailHolder}`}>
                <div className={`flex flex-col align-items-center ${style.journalInfo}`}>
                ...
                {/* Chart Display */}
                {!showSmallJournal && Object.keys(chartData).length && (
                ...
                <div className={`flex flex-col align-items-center ${style.journalAcct}`}>
